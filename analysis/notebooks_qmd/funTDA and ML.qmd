...
if (n_pc_keep < 2) warning("If there are fewer than 2 PCs, 2D plotting will fail. Please lower the threshold or use the full number of PCs.")
...
km_scatter_panel <- (wrap_plots(p_gt_cluster, p_km_raw, p_km_pca, ncol = 3, guides = "collect") &
                       ...
                       plot_annotation(title = "Section 1.2: K-Means Clustering Results Across Data Inputs") &
